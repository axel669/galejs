...
function peg$parse(input, options) {
  ...
  const peg$r14 = /^[a-zA-Z_$0-9]/;
  const peg$r15 = /^[$a-zA-Z_]/;
  const peg$r16 = /^[$a-zA-Z_0-9\-]/;
  const peg$r17 = /^[$a-zA-Z_0-9\-:]/;
  const peg$r18 = /^[^"]/;
  const peg$r19 = /^[^{`]/;
  const peg$r20 = /^[^{}"]/;
  const peg$r21 = /^[ \t\n\r]/;
  ...
  const peg$e2 = peg$literalExpectation("#effect", false);
  const peg$e3 = peg$classExpectation(["{"], true, false, false);
  ...
  const peg$e24 = peg$classExpectation([["a", "z"]], false, false, false);
  const peg$e25 = peg$classExpectation(["$", ["a", "z"], ["A", "Z"], ["0", "9"], "_", ".", "[", "]", "\"", "'", "`", "(", ")", ",", "-", ":"], false, false, false);
  const peg$e26 = peg$literalExpectation("<#frag", false);
  ...
  const peg$e37 = peg$literalExpectation("{#slot", false);
  ...
  const peg$e42 = peg$classExpectation([["a", "z"], ["A", "Z"], "_", "$", ["0", "9"]], false, false, false);
  const peg$e43 = peg$literalExpectation("{#if", false);
  const peg$e44 = peg$literalExpectation("{#else}", false);
  const peg$e45 = peg$literalExpectation("{#each", false);
  ...
  const peg$e49 = peg$classExpectation(["$", ["a", "z"], ["A", "Z"], "_", ["0", "9"], "-"], false, false, false);
  const peg$e50 = peg$literalExpectation("=", false);
  const peg$e51 = peg$literalExpectation("{...", false);
  const peg$e52 = peg$classExpectation(["$", ["a", "z"], ["A", "Z"], "_", ["0", "9"], "-", ":"], false, false, false);
  ...
  function peg$f0(parts) {
    return parts.filter(part => part !== null)
  }
  function peg$f1(react, code) {
  ...
  function peg$f6(tag, props) {
    return { tag, props, children: [] }
  }
  function peg$f7(tag, props, children, close) {
    return {
        tag,
        props,
        children: children.filter(child => child !== null),
  ...
  function peg$f9(tag) {    return tag  }
  ...
  function peg$f12(js) {    return { js }  }
  function peg$f13(slot, propName, content) {
    return {
        slot,
  ...
  function peg$f14(condition, content, els) {
    return {
        condition,
        content: content.filter(item => item !== null),
  ...
  function peg$f15(each, expand, content, els) {
    return {
        each: each.trim(),
        expand: expand.trim(),
        content: content.filter(item => item !== null),
  ...
  function peg$f17(name) {    return [name, name]  }
  function peg$f18(start, name) {    return [`${start}:${name}`, name]  }
  function peg$f19(name, value) {    return [name, value]  }
  function peg$f20(name, str) {
    return [name, `"${str.join("")}"`]
  }
  function peg$f21(name, str) {
    return [name, `\`${str.join("")}\``]
  }
  function peg$f22(name) {    return [name, "true"]  }
  function peg$f23(js) {    return `...${js}`  }
  function peg$f24(code) {    return `\${${code}}`  }
  function peg$f25(js) {    return js  }
  ...
  function peg$parsePropInterString() {
    let s0, s1, s2, s3;
